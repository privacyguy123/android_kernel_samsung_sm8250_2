...
#endif
	if (ufshpb_is_hpb_flag(rq) && !ufshpb_is_discard_cmd(cmd))
...
static inline void ufshpb_set_unset_rt_all_cmd(unsigned char *cdb)
{
	cdb[0] = UFSHPB_WRITE_BUFFER;
